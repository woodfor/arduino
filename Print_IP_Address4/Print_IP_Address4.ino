...
#define FIREBASE_FCM_DEVICE_TOKEN_1 "ebYpkYQlfw0:APA91bEGcbUABBfpf72okYjzgDZ5xN88_eUf07JnBjKFBM96--BkQTJr3m2eVj8mIIOe54rkWGewgHQE3VsoOLolJ6SWn6dOn9uuhf-y0IWOmW_NemEcu-VvvLo_IpZe4M1HPbWCkACC"
  ...
  { 
    ...
    */
    ...
    if(flowRate > 0)
    {
      ...
      {
        sendNotification("IOT","Your tap is on, at least 2 seconds");
